...
public interface WebSocketSenderApi {
     ...
     */
    default void sendByIdCard(String idCard, String messageType, String messageContent) {
        send(new WebSocketSendReqDTO().setIdCard(idCard).setMessageType(messageType).setMessageContent(messageContent)).checkError();
    }
