package com.chinasoft.cloud.module.infra.controller.admin.config;
...
import com.chinasoft.cloud.module.infra.controller.admin.config.vo.ConfigPageReqVO;
import com.chinasoft.cloud.module.infra.controller.admin.config.vo.ConfigRespVO;
import com.chinasoft.cloud.module.infra.controller.admin.config.vo.ConfigSaveReqVO;
import com.chinasoft.cloud.module.infra.convert.config.ConfigConvert;
import com.chinasoft.cloud.module.infra.dal.dataobject.config.ConfigDO;
import com.chinasoft.cloud.module.infra.enums.ErrorCodeConstants;
import com.chinasoft.cloud.module.infra.service.config.ConfigService;
...
@Tag(name = "管理后台 - 参数配置")
@RestController
@RequestMapping("/proxy/ai/v1/infra/config")
@Validated
