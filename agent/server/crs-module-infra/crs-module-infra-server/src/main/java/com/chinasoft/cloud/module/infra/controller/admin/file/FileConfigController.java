...
import com.chinasoft.cloud.module.infra.controller.admin.file.vo.config.FileConfigRespVO;
...
import com.chinasoft.cloud.module.infra.service.file.FileConfigService;
...
@Tag(name = "管理后台 - 文件配置")
@RestController
@RequestMapping("/proxy/ai/v1/infra/file-config")
@Validated
