package com.chinasoft.cloud.module.infra.controller.admin.job;
...
import static com.chinasoft.cloud.framework.common.pojo.CommonResult.error;

@Tag(name = "管理后台 - 定时任务")
@RestController
@RequestMapping("/proxy/ai/v1/infra/job")
@Validated
