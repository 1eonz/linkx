package com.chinasoft.cloud.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.chinasoft.cloud.framework.common.util.json.JsonUtils;
import com.chinasoft.cloud.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from crs-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 芋道源码
 */
@Slf4j
