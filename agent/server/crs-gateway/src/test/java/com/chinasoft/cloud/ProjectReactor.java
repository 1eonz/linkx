...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.chinasoft.cloud";
    private static final String ARTIFACT_ID = "crs";
    private static final String PACKAGE_NAME = "com.chinasoft.cloud";
    private static final String TITLE = "成铁智能应用";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.chinasoft.cloud";
        String artifactIdNew = "crs";
        String packageNameNew = "com.chinasoft.cloud";
        String titleNew = "成铁智能应用";
