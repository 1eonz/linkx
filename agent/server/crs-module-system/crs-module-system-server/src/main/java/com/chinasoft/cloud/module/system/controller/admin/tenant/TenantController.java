package com.chinasoft.cloud.module.system.controller.admin.tenant;
...
import com.chinasoft.cloud.module.system.controller.admin.tenant.vo.tenant.TenantRespVO;
...
@Tag(name = "管理后台 - 租户")
@RestController
@RequestMapping("/proxy/ai/v1/system/tenant")
