...
import com.chinasoft.cloud.module.system.controller.admin.mail.vo.template.*;
import com.chinasoft.cloud.module.system.dal.dataobject.mail.MailTemplateDO;
import com.chinasoft.cloud.module.system.service.mail.MailSendService;
import com.chinasoft.cloud.module.system.service.mail.MailTemplateService;
...
@Tag(name = "管理后台 - 邮件模版")
@RestController
@RequestMapping("/proxy/ai/v1/system/mail-template")
