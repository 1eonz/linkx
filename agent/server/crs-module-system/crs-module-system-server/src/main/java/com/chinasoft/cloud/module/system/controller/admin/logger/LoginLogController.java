...
import com.chinasoft.cloud.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import com.chinasoft.cloud.module.system.controller.admin.logger.vo.loginlog.LoginLogRespVO;
import com.chinasoft.cloud.module.system.dal.dataobject.logger.LoginLogDO;
...
@Tag(name = "管理后台 - 登录日志")
@RestController
@RequestMapping("/proxy/ai/v1/system/login-log")
@Validated
