...
// import com.chinasoft.cloud.module.system.api.social.dto.*;
// import com.chinasoft.cloud.module.system.enums.social.SocialTypeEnum;
// import com.chinasoft.cloud.module.system.service.social.SocialClientService;
...
// return success(convertList(list, item -> BeanUtils.toBean(item,
// SocialWxaSubscribeTemplateRespDTO.class).setId(item.getPriTmplId())));
// }
//
// @Override
...
//
// @Override
// public CommonResult<Boolean> uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO
// reqDTO) {
...
//
// @Override
// public CommonResult<Boolean> notifyWxaOrderConfirmReceive(Integer userType, SocialWxaOrderNotifyConfirmReceiveReqDTO
// reqDTO) {
