...
import com.chinasoft.cloud.module.system.controller.admin.tenant.vo.packages.TenantPackageRespVO;
import com.chinasoft.cloud.module.system.controller.admin.tenant.vo.packages.TenantPackageSaveReqVO;
import com.chinasoft.cloud.module.system.controller.admin.tenant.vo.packages.TenantPackageSimpleRespVO;
import com.chinasoft.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.chinasoft.cloud.module.system.service.tenant.TenantPackageService;
...
@Tag(name = "管理后台 - 租户套餐")
@RestController
@RequestMapping("/proxy/ai/v1/system/tenant-package")
@Validated
