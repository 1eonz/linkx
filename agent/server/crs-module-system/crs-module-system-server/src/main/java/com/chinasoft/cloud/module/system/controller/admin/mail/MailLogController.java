...
import com.chinasoft.cloud.module.system.controller.admin.mail.vo.log.MailLogRespVO;
import com.chinasoft.cloud.module.system.dal.dataobject.mail.MailLogDO;
import com.chinasoft.cloud.module.system.service.mail.MailLogService;
...
@Tag(name = "管理后台 - 邮件日志")
@RestController
@RequestMapping("/proxy/ai/v1/system/mail-log")
