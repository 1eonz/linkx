...
import com.chinasoft.cloud.module.system.controller.admin.notify.vo.message.NotifyMessageMyPageReqVO;
import com.chinasoft.cloud.module.system.controller.admin.notify.vo.message.NotifyMessagePageReqVO;
import com.chinasoft.cloud.module.system.controller.admin.notify.vo.message.NotifyMessageRespVO;
import com.chinasoft.cloud.module.system.dal.dataobject.notify.NotifyMessageDO;
import com.chinasoft.cloud.module.system.service.notify.NotifyMessageService;
...
@Tag(name = "管理后台 - 我的站内信")
@RestController
@RequestMapping("/proxy/ai/v1/system/notify-message")
@Validated
