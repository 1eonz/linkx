...
import com.chinasoft.cloud.module.system.controller.admin.sms.vo.log.SmsLogPageReqVO;
import com.chinasoft.cloud.module.system.controller.admin.sms.vo.log.SmsLogRespVO;
import com.chinasoft.cloud.module.system.dal.dataobject.sms.SmsLogDO;
import com.chinasoft.cloud.module.system.service.sms.SmsLogService;
...
@Tag(name = "管理后台 - 短信日志")
@RestController
@RequestMapping("/proxy/ai/v1/system/sms-log")
@Validated
