...
// @Parameters({
// @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
// @Parameter(name = "phoneCode", description = "手机授权码", example = "crs11", required = true)
// })
...
// CommonResult<List<SocialWxaSubscribeTemplateRespDTO>> getWxaSubscribeTemplateList(@RequestParam("userType") Integer
// userType);
//
