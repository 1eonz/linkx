package com.chinasoft.cloud.framework.ratelimiter.config;

import com.chinasoft.cloud.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.chinasoft.cloud.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.chinasoft.cloud.framework.ratelimiter.core.keyresolver.impl.*;
import com.chinasoft.cloud.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class CrsRateLimiterConfiguration {
