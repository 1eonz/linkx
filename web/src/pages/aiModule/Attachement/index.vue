...
import { FILE_TYPE, previewableTypes } from "./unit"
...
const fullPath = computed(()=> {
    ...
    console.log('完整文件路径',`${getIp()}/linkx/desktop/cloudcmd${fileUrl}`, getIp(), fileUrl)
    return `${getIp()}/linkx/desktop/cloudcmd${fileUrl}`
})
</script>
