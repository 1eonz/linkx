...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> success() {
        return new R<>(ResponseCodeEnum.SUCCESS.getCode(), I18nUtil.get(ResponseCodeEnum.SUCCESS.getMsg()));
    }
    ...
    public static <T> R<T> success(T data) {
        return new R<>(ResponseCodeEnum.SUCCESS.getCode(), data, I18nUtil.get(ResponseCodeEnum.SUCCESS.getMsg()));
    }
    ...
    public static <T> R<T> failure() {
        return new R<>(ResponseCodeEnum.FAILURE.getCode(), I18nUtil.get(ResponseCodeEnum.FAILURE.getMsg()));
    }
    ...
    public static <T> R<T> failure(T data) {
        return new R<>(ResponseCodeEnum.FAILURE.getCode(), data, I18nUtil.get(ResponseCodeEnum.FAILURE.getMsg()));
