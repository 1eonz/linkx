...
public class NettyServerStarter implements SmartLifecycle {
    ...
    private EventLoopGroup socketBossGroup;
    ...
    public void start() {
        ...
        socketBossGroup = new NioEventLoopGroup(cagentProperties.getBossGroupThread());
        ...
        webSocketServer.start(websocketBossGroup, workGroup, webSocketChannelInitializer, cagentProperties.getWebPort(),
            "ws server");
        socketServer = new NettyServer();
        socketServer.start(socketBossGroup, workGroup, socketChannelInitializer, cagentProperties.getSocketPort(),
            "socket server");
        isRunning = true;
    }
