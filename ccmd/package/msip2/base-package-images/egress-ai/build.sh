...
function main() {
  ...
  mkdir -p "${target_dir}/script/upgrade/shell/egress-ai" && \
    cp "${script_path}/before-patch.sh" "${target_dir}/script/upgrade/shell/egress-ai/before.sh" && \
    cp "${script_path}/after-patch.sh" "${target_dir}/script/upgrade/shell/egress-ai/after.sh"
  mkdir -p "${target_dir}/script/rollback/shell/egress-ai" && \
    cp "${script_path}/before-patch.sh" "${target_dir}/script/rollback/shell/egress-ai/before.sh" && \
    cp "${script_path}/after-patch.sh" "${target_dir}/script/rollback/shell/egress-ai/after.sh"
